...
set "INC=-I%CRAFT%\include -I%CRAFT%\include\QtCore -I%CRAFT%\include\QtGui -I%CRAFT%\include\QtQml -I%CRAFT%\include\QtQuick -I%CRAFT%\include\KF6 -I%CRAFT%\mkspecs\win32-msvc -I%SRC%"
...
set "LIBS=/LIBPATH:%CRAFT%\lib Qt6Core.lib Qt6Gui.lib Qt6Qml.lib Qt6Quick.lib ole32.lib user32.lib shell32.lib gdi32.lib"
...
cl /nologo /LD /EHsc /MD /utf-8 /O2 /Ob1 /DNDEBUG /Zc:__cplusplus /permissive- /std:c++17 %DEFS% %INC% -I"%OUT%" ^
    "%SRC%\startmenumodel.cpp" "%SRC%\startmenuimageprovider.cpp" "%SRC%\plugin.cpp" "%OUT%\moc_startmenumodel.cpp" ^
